...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_edays']; ?>";</script>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to Engineering Days</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_edays"];?></p>
                      <button type="submit" name="edays_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
