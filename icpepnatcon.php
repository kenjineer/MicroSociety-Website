...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_icpepnatcon']; ?>";</script>
    <header role="banner">
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>ICpEP National Convention</h1><br><br><br>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to ICpEP National Convention</h2>
            <h2 class="mb-10">Greetings!<br><br> 
 
The Institute of Computer Engineers of the Philippines (ICpEP), Incorporated will hold the 2018 ICpEP National Convention, 6th National Conference on Computer Applications, Innovations, Technologies and Engineering (CAITE 2018), 2018 National CpE Challenge and General Assembly on November 26-29, 2018 at Hotel Supreme Convention Plaza, Magsaysay Avenue, Baguio City with its theme “Enhancing Computer Engineers’ Capability towards Fourth Industrial Revolution and Technology Business Incubation”.<br><br>

The convention objectives are as follows:<br>
1) To gather all Computer Engineering professionals;<br>
2) To update participants on the latest/future trends in the industry;<br>
3) To share quality research outputs of Computer Engineers; and<br>
4) To enhance competencies of Computer Engineering students through various competitions.<br><br>

Should you have queries and concerns, please contact Engr. Dionisio R. Tandingan Jr. (VP for Education) at 0939-9200038 or email at dion_tand@yahoo.com.</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_icpepnatcon"];?></p>
                      <button type="submit" name="icpepnatcon_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
