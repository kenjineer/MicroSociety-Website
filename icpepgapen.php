...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_icpepga']; ?>";</script>
    <header role="banner">
     <section>
      <style>
        .alert {
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>ICpEP General Assembly and CpEyesta</h1><br><br><br>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to ICpEP General Assembly and CpEyesta</h2>
            <h2 class="mb-10">Hello Committed Productive Engineers!<br><br>

The Institute of Computer Engineers of the Philippines Region IVA (ICpEP-IVA) is organizing its 4th General Assembly, CpEyesta and CpE Challenge with the theme “The Quest for One ICpEP towards Professionalism and Collaboration” on Sept 22-23, 2017, Saturday-Sunday respectively, 8:00-5:00, at the Gym, Colegio de San Juan de Letran Calamba, Calamba City.<br><br>

For more queries, please contact Mr. Kenneth Karamihan or Ms. Anicia Coleen Reyes.</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_icpepga"];?></p>
                      <button type="submit" name="icpepga_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
