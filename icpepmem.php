...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_icpepmem']; ?>";</script>
    <header role="banner">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to ICpEP MEmbership</h2>
            <h2 class="mb-10">Hello Committed Productive Engineers!<br><br>

Application for membership on Institute of Computer Engineers of the Philippines Student Edition (ICpEP.SE) Region 4A is now open for all students under the BSCpE program. Membership fees are listed below.<br><br>

New Membership (w/ Membership Card): Php 200.00<br>
Old Membership: Php 150.00<br>
Deadline: September 10, 2018<br><br>

You may contact Mr. Kenneth Karamihan or Ms Anicia Coleen Reyes for more queries.<br><br>

Be an ICpEP.SE R4A member now! </h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_icpepmem"];?></p>
                      <button type="submit" name="icpepmem_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
