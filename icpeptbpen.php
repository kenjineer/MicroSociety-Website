...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_icpeptb']; ?>";</script>
    <header role="banner">
     <section>
      <style>
        .alert {
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to ICpEP Team Building</h2>
            <h2 class="mb-10">Hello Committed Productive Engineers!<br><br>

The Institute of Computer Engineers of the Philippines Region 4A (ICpEP-IVA) is organizing its Annual Team Building Activity for CpE Student Leaders and Advisers with the theme “The Quest for One ICpEP towards Professionalism and Collaboration” on August 24, 2018, 8:00AM, Friday at the Gym, Colegio de San Juan de Letran Calamba, Calamba City.<br><br>

For more queries, you may contact Mr. Kenneth Karamihan or Ms. Anicia Coleen Reyes.</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_icpeptb"];?></p>
                      <button type="submit" name="icpeptb_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
