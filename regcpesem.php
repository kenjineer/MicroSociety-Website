...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_cpesem']; ?>";</script>
    <header role="banner">
        ...
        <div class="row align-items-center site-hero-inner justify-content-center">
          <div class="col-md-8 text-center">
            ...
            <div class="mb-5 element-animate">
              <h1>CpE Technology Enrichment Seminar</h1><br><br><br>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to CpE Technology Enrichment Seminar</h2>
            <h2 class="mb-10">We are pleased to inform that MicroSociety (UPHSL Computer Engineering Society) will be holding its 2016 Technology Enrichment Seminar for Computer Engineering Students with the theme “Encrypting the Past Decoding the Future” on January 16, 2016, Saturday, from 8:00am – 5:00 pm at Performing Arts Theater of the University of Perpetual Help System Laguna – Biñan Campus, City of Biñan, Laguna. Registration starts at 7:00 am.</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_cpesem"];?></p>
                      <button type="submit" name="cpesem_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <ul class="list-unstyled">
                  ...
                  <li><a href="index.html" class="nav-link" action="includes/logout-inc.php">Logout</a></li>
                </ul>
              </div>
            </div>
          </div>
