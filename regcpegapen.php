...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_cpega']; ?>";</script>
    <header role="banner">
     <section>
      <style>
        .alert {
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to CpE General Assembly</h2>
            <h2 class="mb-10">Hey there Computer Engineers!<br><br>

The UPHSL MicroSociety invites you to our CpE General Assembly 2018 with the theme "Emerging Beyond Technological Breakthroughs on Offensive Security" this coming Friday, August 17, 2018 8am at the Basic Ed. Mini Auditorium.<br><br>

Registration Fee<br>
1st yr: Php 50.00<br>
4th yr and 5th yr: Php 150.00<br><br>

Guest Speakers:<br>
Prof. Rhowel M. Dellosa (Ethical Hacking)<br>
Engr. John Bairy Rosalinas (Inspirational Talk)<br>

Explore your CpE profession and Emerge for the betterment of our world!</h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-6=10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_cpega"];?></p>
                      <button type="submit" name="cpega_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
