...
<html lang="en">
  ...
  <body>
    ...
    ?>
    <script> reg = "<?php echo $_SESSION['u_icpeplympics']; ?>";</script>
    <header role="banner">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <h2 class="mb-5">Register to ICpEP CpElympics</h2>
            <h2 class="mb-10">Greetings from ICpEP.SE R4A!<br><br>

We are pleased to inform that we will be holding our 3rd CpElympics and CpEyesta 2018 on February 8-9, 2018 at the University of Perpetual Help System Laguna – Biñan Campus, City of Biñan, Laguna.<br><br>

See you there guys! </h2>
            <form action="includes/register-inc.php" method="post">
                  <div class="row">
                    <div class="col-md-10 form-group">
                      <p>Registration Status: <?php echo $_SESSION["u_icpeplympics"];?></p>
                      <button type="submit" name="icpeplympics_submit" class="btn btn-primary" id="register">Register</button>
                    </div>
                  </div>
                </form>
          </div>
